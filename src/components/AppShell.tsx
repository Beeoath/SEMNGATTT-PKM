...
export const AppShell: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const isSpatialView =
    ...
    (isDashboardView ||
      ...
      location.pathname === "/app/hub/" ||
      location.pathname === "/app/journey" ||
      location.pathname === "/app/journey/" ||
      location.pathname === "/app/peta" ||
      location.pathname === "/app/peta/" ||
    ...
    >
      ...
      {!isSpatialView && (
        ...
        <div className="mx-auto flex h-16 w-full max-w-[1600px] items-center justify-between px-3 sm:px-5 lg:px-6">
          ...
          {/* Right: Theme Toggle, User Status & Logout */}
        ...
        {mobileMenuOpen && (
          ...
          >
            {/* Quick theme toggle row in mobile menu */}
            <div className="flex items-center justify-between pb-2 border-b border-white/10 dark:border-white/10">
              <span className="text-xs font-medium text-slate-500">Mode Tema</span>
      ...
      <main
        className={`flex-1 relative z-10 w-full ${
          isSpatialView ? "overflow-x-hidden" : "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6 sm:py-8"
        }`}
      >
        {children}
      </main>
