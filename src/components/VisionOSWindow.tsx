...
export const VisionOSWindow: React.FC<VisionOSWindowProps> = ({
  ...
  return (
    <div
      className={`relative min-h-screen w-full overflow-hidden py-4 sm:py-8 px-2 sm:px-6 lg:px-10 flex flex-col items-center justify-start transition-colors duration-300 ${
    ...
    >
      ...
      <div className="relative z-20 w-full max-w-7xl flex flex-col md:flex-row items-start gap-3 sm:gap-5 justify-center">
        ...
        <aside
          className={`shrink-0 flex md:flex-col items-center justify-center gap-2 md:gap-3.5 rounded-full p-2 sm:p-2.5 shadow-2xl backdrop-blur-2xl mx-auto md:mx-0 md:sticky md:top-24 transition-all ${
            isDark
        ...
        <main
          className={`flex-1 w-full rounded-[28px] sm:rounded-[36px] lg:rounded-[42px] p-4 sm:p-6 lg:p-8 backdrop-blur-3xl overflow-hidden relative transition-all ${
            isDark
